...
function Signup({ setSignupModal,setIsuser }) {
    ...
    return (
        <div>
            <div id="YOUR_ID" className="fixed z-50 inset-0 overflow-y-auto w-[450px] mx-auto">
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6"
                        ...
                        <div className="flex justify-between text-black ">
                            ...
                            <button onClick={() => setSignupModal(false)} type="button" data-behavior="cancel" className="bg-white rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        ...
                        <div className=" text-black">
                            <div className=" flex mt-8 mb-4  border-2 rounded-lg px-3 gap-2 text-black text-base  items-center ">
                                <input className=" w-full border-none placeholder:text-lg outline-none  py-3" type="text" name="fullname" value={SignupInfo.fullname} onChange={SingupInfoHandler} id="" placeholder="Full Name" />
                            </div>
                            <div className=" flex mt-5 mb-4  border-2 rounded-lg px-3 gap-2 text-black text-base  items-center ">
                                <input className=" w-full border-none placeholder:text-lg outline-none  py-3" type="email" name="email" value={SignupInfo.email} onChange={SingupInfoHandler} id="" placeholder="Email" />
                            </div>
                            <div className="flex gap-1  items-start my-5">
                                 <input className="mt-2" type="checkbox" name="" id="" />
                                 <p className=" text-sm">I agree to Zomato's <span className=" text-red-500">Terms of Service, Privacy Policy</span>  and <span className=" text-red-500">Content Policies</span> </p>
                            </div>
                            <div className=" bg-red-500 text-white hover:bg-red-600 w-full py-2 px-3 text-center text-lg rounded-md">
                                <button onClick={submitbtnhandler} type="submit">Create Account</button>
                            </div>
                            ...
                            <div className=" flex  text-lg gap-2">
                                <p className=" text-gray-800">Already have an account?</p><p className=" text-red-400">Log In</p>
                            </div>
                        </div>
